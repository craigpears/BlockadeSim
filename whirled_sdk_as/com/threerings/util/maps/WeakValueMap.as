//
// $Id: WeakValueMap.as 144 2009-10-22 23:39:33Z ray $
//
...
/**
 * A Map that stores weak weak values. If the values are not referenced anywhere else in
 * the runtime, this Map may unexpectedly shrink in size.
 * Note that it is not currently safe to use this Map in combination with an LRIMap.
 */
